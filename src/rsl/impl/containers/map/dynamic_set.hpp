...
namespace rsl
{
    ...
    class dynamic_set : public hash_map_base<map_info<Key, void, Flags, Hash, KeyEqual, MaxLoadFactor, FingerprintSize>>
    {
    public:
        using container_base = hash_map_base<map_info<Key, void, Flags, Hash, KeyEqual, MaxLoadFactor, FingerprintSize>>;
        ...
        using hash_map_base<map_info<Key, void, Flags, Hash, KeyEqual, MaxLoadFactor, FingerprintSize>>::hash_map_base;

        [[rythe_always_inline]] constexpr dynamic_set(const container_base& src)
                noexcept(container_base::copy_construct_container_noexcept);
        [[rythe_always_inline]] constexpr dynamic_set(container_base&& src)
                noexcept(container_base::copy_construct_container_noexcept);
