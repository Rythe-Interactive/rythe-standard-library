...
namespace rsl
{
	...
	class dynamic_map :
		public hash_map_base<
			map_info<Key, Value, Flags, FactoryType, Hash, KeyEqual, MaxLoadFactor, FingerprintSize>>
	{
	public:
		using hash_map_base<
			map_info<Key, Value, Flags, FactoryType, Hash, KeyEqual, MaxLoadFactor, FingerprintSize>>::hash_map_base;
	};
} // namespace rsl
