...
namespace rsl
{
	...
	void error_handler::handle_error(const error_type& err, const bool assertError)
	{
		switch (err.severity)
		{
			case error_severity::warning:
			{
				...
				{
					log::warn("{}: {}"_sv, err.code, err.message);
				}
				break;
			}
			case error_severity::error:
			{
				...
				{
					log::error("{}: {}"_sv, err.code, err.message);
				}
				break;
			}
			case error_severity::fatal:
			{
				...
				{
					log::fatal("{}: {}"_sv, err.code, err.message);
				}
				break;
			}
		}
