...
namespace rsl::log
{
    ...
    public:
        ...
        virtual void format(const message& msg, time_span time, fmt::memory_buffer& dest) = 0;
    ...
    {
    public:
        void format(const message& msg, time_span time, fmt::memory_buffer& dest) override;
    };
